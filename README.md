...
| 🕒 Last generated | 2026-09-18T11:05:42Z |
| ✅ Last successful refresh | 2026-09-18T11:05:42Z |
| 🔁 Total runs | 734 |
| 🌐 Total outbound requests | 108659558 |
| 🧪 Total proxies checked | 97844856 |
| 📡 Total validated proxies | 653778 |

## 📂 Published Lists

| File | Description | Count |
| --- | --- | ---: |
| [http.txt](http.txt) | Validated HTTP proxies | 68 |
| [https.txt](https.txt) | HTTP proxies with CONNECT tunnel support | 25 |
| [socks4.txt](socks4.txt) | Validated SOCKS4 proxies | 179 |
| [socks5.txt](socks5.txt) | Validated SOCKS5 proxies | 65 |
| [all.txt](all.txt) | Combined scheme-qualified list | 312 |
...
| [docs/data/proxies.json](docs/data/proxies.json) | Machine-readable validated proxy metadata | 312 |
