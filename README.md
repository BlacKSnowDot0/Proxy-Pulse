...
| 🕒 Last generated | 2026-09-18T04:26:28Z |
| ✅ Last successful refresh | 2026-09-18T04:26:28Z |
| 🔁 Total runs | 733 |
| 🌐 Total outbound requests | 108517462 |
| 🧪 Total proxies checked | 97784739 |
| 📡 Total validated proxies | 653466 |
...
| [https.txt](https.txt) | HTTP proxies with CONNECT tunnel support | 39 |
| [socks4.txt](socks4.txt) | Validated SOCKS4 proxies | 175 |
| [socks5.txt](socks5.txt) | Validated SOCKS5 proxies | 108 |
| [all.txt](all.txt) | Combined scheme-qualified list | 373 |
...
| [docs/data/proxies.json](docs/data/proxies.json) | Machine-readable validated proxy metadata | 373 |
