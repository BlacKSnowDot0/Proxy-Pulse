...
| 🕒 Last generated | 2026-03-25T02:59:29Z |
| ✅ Last successful refresh | 2026-03-25T02:59:29Z |
| 🔁 Total runs | 42 |
| 🌐 Total outbound requests | 4971492 |
| 🧪 Total proxies checked | 4916961 |
| 📡 Total validated proxies | 113291 |

## 📂 Published Lists

| File | Description | Count |
| --- | --- | ---: |
| [http.txt](http.txt) | Validated HTTP proxies | 85 |
| [socks4.txt](socks4.txt) | Validated SOCKS4 proxies | 150 |
| [socks5.txt](socks5.txt) | Validated SOCKS5 proxies | 1035 |
| [all.txt](all.txt) | Combined scheme-qualified list | 1270 |
...
| [docs/data/proxies.json](docs/data/proxies.json) | Machine-readable validated proxy metadata | 1270 |
