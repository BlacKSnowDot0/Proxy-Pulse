...
| 🕒 Last generated | 2026-08-20T07:01:10Z |
| ✅ Last successful refresh | 2026-08-20T07:01:10Z |
| 🔁 Total runs | 628 |
| 🌐 Total outbound requests | 96646944 |
| 🧪 Total proxies checked | 91467953 |
| 📡 Total validated proxies | 620230 |

## 📂 Published Lists

| File | Description | Count |
| --- | --- | ---: |
| [http.txt](http.txt) | Validated HTTP proxies | 136 |
| [https.txt](https.txt) | HTTP proxies with CONNECT tunnel support | 65 |
| [socks4.txt](socks4.txt) | Validated SOCKS4 proxies | 164 |
| [socks5.txt](socks5.txt) | Validated SOCKS5 proxies | 78 |
| [all.txt](all.txt) | Combined scheme-qualified list | 378 |
...
| [docs/data/proxies.json](docs/data/proxies.json) | Machine-readable validated proxy metadata | 378 |
