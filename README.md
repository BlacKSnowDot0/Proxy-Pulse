...
| 🕒 Last generated | 2026-05-27T20:34:54Z |
| ✅ Last successful refresh | 2026-05-27T20:34:54Z |
| 🔁 Total runs | 292 |
| 🌐 Total outbound requests | 39409904 |
| 🧪 Total proxies checked | 39713204 |
| 📡 Total validated proxies | 403965 |

## 📂 Published Lists

| File | Description | Count |
| --- | --- | ---: |
| [http.txt](http.txt) | Validated HTTP proxies | 790 |
| [socks4.txt](socks4.txt) | Validated SOCKS4 proxies | 175 |
| [socks5.txt](socks5.txt) | Validated SOCKS5 proxies | 576 |
| [all.txt](all.txt) | Combined scheme-qualified list | 1541 |
...
| [docs/data/proxies.json](docs/data/proxies.json) | Machine-readable validated proxy metadata | 1541 |
