...
| 🕒 Last generated | 2026-09-20T04:42:24Z |
| ✅ Last successful refresh | 2026-09-20T04:42:24Z |
| 🔁 Total runs | 741 |
| 🌐 Total outbound requests | 109529818 |
| 🧪 Total proxies checked | 98265487 |
| 📡 Total validated proxies | 656441 |

## 📂 Published Lists

| File | Description | Count |
| --- | --- | ---: |
| [http.txt](http.txt) | Validated HTTP proxies | 128 |
| [https.txt](https.txt) | HTTP proxies with CONNECT tunnel support | 60 |
| [socks4.txt](socks4.txt) | Validated SOCKS4 proxies | 178 |
| [socks5.txt](socks5.txt) | Validated SOCKS5 proxies | 167 |
| [all.txt](all.txt) | Combined scheme-qualified list | 473 |
...
| [docs/data/proxies.json](docs/data/proxies.json) | Machine-readable validated proxy metadata | 473 |
