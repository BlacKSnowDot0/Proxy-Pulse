...
| 🕒 Last generated | 2026-08-31T22:49:19Z |
| ✅ Last successful refresh | 2026-08-31T22:49:19Z |
| 🔁 Total runs | 667 |
| 🌐 Total outbound requests | 100858404 |
| 🧪 Total proxies checked | 93812843 |
| 📡 Total validated proxies | 632025 |

## 📂 Published Lists

| File | Description | Count |
| --- | --- | ---: |
| [http.txt](http.txt) | Validated HTTP proxies | 157 |
| [https.txt](https.txt) | HTTP proxies with CONNECT tunnel support | 38 |
| [socks4.txt](socks4.txt) | Validated SOCKS4 proxies | 184 |
| [socks5.txt](socks5.txt) | Validated SOCKS5 proxies | 40 |
| [all.txt](all.txt) | Combined scheme-qualified list | 381 |
...
| [docs/data/proxies.json](docs/data/proxies.json) | Machine-readable validated proxy metadata | 381 |
