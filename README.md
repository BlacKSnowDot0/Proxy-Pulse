...
| 🕒 Last generated | 2026-03-22T18:57:12Z |
| ✅ Last successful refresh | 2026-03-22T18:57:12Z |
| 🔁 Total runs | 33 |
| 🌐 Total outbound requests | 3679934 |
| 🧪 Total proxies checked | 3659852 |
| 📡 Total validated proxies | 103729 |

## 📂 Published Lists

| File | Description | Count |
| --- | --- | ---: |
| [http.txt](http.txt) | Validated HTTP proxies | 94 |
| [socks4.txt](socks4.txt) | Validated SOCKS4 proxies | 12 |
| [socks5.txt](socks5.txt) | Validated SOCKS5 proxies | 1536 |
| [all.txt](all.txt) | Combined scheme-qualified list | 1642 |
...
| [docs/data/proxies.json](docs/data/proxies.json) | Machine-readable validated proxy metadata | 1642 |
