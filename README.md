...
| 🕒 Last generated | 2026-06-25T04:21:41Z |
| ✅ Last successful refresh | 2026-06-25T04:21:41Z |
| 🔁 Total runs | 403 |
| 🌐 Total outbound requests | 55800489 |
| 🧪 Total proxies checked | 55896194 |
| 📡 Total validated proxies | 480041 |

## 📂 Published Lists

| File | Description | Count |
| --- | --- | ---: |
| [http.txt](http.txt) | Validated HTTP proxies | 333 |
| [socks4.txt](socks4.txt) | Validated SOCKS4 proxies | 192 |
| [socks5.txt](socks5.txt) | Validated SOCKS5 proxies | 137 |
| [all.txt](all.txt) | Combined scheme-qualified list | 662 |
...
| [docs/data/proxies.json](docs/data/proxies.json) | Machine-readable validated proxy metadata | 662 |
